...
@section('content')
    <form action="{{ route('action-tambah') }}" method="POST" enctype="multipart/form-data" class="mx-3"
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('tempat') is-invalid @enderror" id="exampleFormControlInput1"
                placeholder="Tempat Acara" name="tempat">
            @error('tempat')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
